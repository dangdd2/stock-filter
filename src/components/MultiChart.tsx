...
function TickerCard({
  ...
  const closes   = item.closes6m  && item.closes6m.length  >= 2 ? item.closes6m
    : item.closes60d && item.closes60d.length >= 2 ? item.closes60d
    : item.closes7d  && item.closes7d.length  >= 2 ? item.closes7d
    : null;
